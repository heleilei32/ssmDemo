    ...
    public static String sendPost(String url, String param,String charsetName) {
        ...
        try {
            ...
            try {
                ...
                logger.info("关闭输入流异常，" + ex.getMessage());
            }
        }
        return result;
    }
    ...
    public static String doHttp(String urlStr, String charSet, Object parameters, int timeOut) throws Exception {
        ...
        for (int i = 0; i < ms.length; i++) {
            ...
            if (name.startsWith("get")) {
                ...
                NameValuePair nvp = new BasicNameValuePair(param,null);
                if (!StringUtils.isEmpty(value)){
                    nvp = new BasicNameValuePair(param, value.toString());
                }
                paramList.add(nvp);
            }
        }
